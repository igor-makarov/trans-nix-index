...
REPO = "https://github.com/igor-makarov/trans-nix-index"
GA_ID = "G-JHW37D1S4W"
...
def strip_tags(fragment):
    """The visible text of a heading, without HTML markup."""
...
def rewrite_links(body):
    ...
    Two kinds need moving. A `./selectors.md` link drops its extension, because the
    ...
    def replace(match):
        ...
        # A sibling docs page: ./selectors.md#x -> ./selectors#x
